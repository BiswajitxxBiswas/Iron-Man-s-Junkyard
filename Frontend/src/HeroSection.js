...
const HeroSection = () => {
  ...
  return (
    <div className="h-screen flex flex-col justify-center items-center text-center text-white bg-hero-pattern bg-cover bg-center">
      ...
      <div className="relative z-10">
        ...
        {/* Button navigates directly to the login page */}
        <button
